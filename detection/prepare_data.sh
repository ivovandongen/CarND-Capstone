...
python src/tf_record_generation.py --output_file out/carla_training_data.record --label_map models/labelmap.pbtxt --input_file data/real_training_data/real_data_annotations.yaml --height 1096 --width 1368
